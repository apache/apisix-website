...
> Route OpenAI-compatible chat traffic from APISIX 3.18 to a private LocalAI deployment, with separate client and upstream authentication.

Source: https://apisix.apache.org/integrations/localai/
