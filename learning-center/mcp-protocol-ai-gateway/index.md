# MCP Protocol & AI Gateways: Managing AI Agent Traffic at Scale

> Learn what Model Context Protocol means for AI agent traffic and how API gateways such as Apache APISIX can secure, observe, and control surrounding LLM API calls.

Source: https://apisix.apache.org/learning-center/mcp-protocol-ai-gateway/
