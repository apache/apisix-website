# Cache LLM responses with Redis: exact and semantic matching

> Test exact and semantic response caching in APISIX 3.18, including tenant isolation, streaming responses, and Redis failures.

Source: https://apisix.apache.org/cookbooks/redis-ai-cache/
