# Share an LLM token quota across APISIX nodes with Redis

> Share a post-response token counter between two APISIX 3.18 nodes, and test cross-node enforcement and Redis failure handling.

Source: https://apisix.apache.org/cookbooks/redis-shared-token-quota/
