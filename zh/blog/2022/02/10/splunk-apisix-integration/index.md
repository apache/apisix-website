# 云原生 API 网关 APISIX 集成 Splunk HTTP Event Collector

> 本文介绍了如何通过云原生 API 网关 Apache APISIX 中的 splunk-hec-logging 插件与 Splunk HEC 服务实现对接，从而将 APISIX 的日志发送到 Splunk HEC 服务中。

Source: https://apisix.apache.org/zh/blog/2022/02/10/splunk-apisix-integration/
