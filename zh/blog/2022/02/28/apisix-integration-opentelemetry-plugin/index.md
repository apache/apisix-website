...
> 本文为您介绍了云原生 API 网关 Apache APISIX 的 opentelemetry 插件的概念以及如何在 APISIX 使用 opentelemetry 插件对接 OpenTelemetry，实现 trace 数据采集。

Source: https://apisix.apache.org/zh/blog/2022/02/28/apisix-integration-opentelemetry-plugin/
