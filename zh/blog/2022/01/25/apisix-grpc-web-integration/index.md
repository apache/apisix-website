# APISIX 支持 gRPC Web 协议请求代理

> 通过社区的积极讨论和贡献，Apache APISIX 又拓宽了 gRPC 生态的支持范围。本文将介绍 gRPC Web 协议请求代理的具体使用步骤及细节。

Source: https://apisix.apache.org/zh/blog/2022/01/25/apisix-grpc-web-integration/
