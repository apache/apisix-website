# APISIX 集成 Kafka 实现高效实时日志监控

> 本文介绍了如何在 Apache APISIX 中使用 kafka-logger 插件。经过多次功能强化后，目前该插件已具备非常成熟且完善的功能。

Source: https://apisix.apache.org/zh/blog/2022/01/17/apisix-kafka-integration/
