...
> 云原生 API 网关 Apache APISIX 近两周新增上游轮询规则策略，支持 etcd 地址为 IPv6，处理上游 header 时自定义 X-Forwarded-Pord 参数。APISIX Dashboard 修正连接中断时数据不同步的问题。

Source: https://apisix.apache.org/zh/blog/2022/11/10/weekly-report-1110/
