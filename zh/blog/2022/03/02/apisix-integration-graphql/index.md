...
> 本文介绍了云原生 API 网关 Apache APISIX 和 GraphQL 的特性，以及如何使用 Apache APISIX 代理 GraphQL 请求，并提出解决实际场景痛点的方案。

Source: https://apisix.apache.org/zh/blog/2022/03/02/apisix-integration-graphql/
