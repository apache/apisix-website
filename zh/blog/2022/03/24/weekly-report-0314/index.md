...
> API 网关 Apache APISIX 社区近两周新增了 authz-keycloak 插件支持重定向非授权用户、csrf 插件支持检查令牌是否过期、proxy-mirror 插件支持设置超时时间等功能。

Source: https://apisix.apache.org/zh/blog/2022/03/24/weekly-report-0314/
