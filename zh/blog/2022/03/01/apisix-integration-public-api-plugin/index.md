# API 网关 APISIX Public API 处理能力再增强

> 你可以通过 API 网关 Apache APISIX 的 public-api 插件保护 APISIX 插件中的自定义 API，本文着重介绍了 `public-api` 插件两种使用方法和一种场景示例。

Source: https://apisix.apache.org/zh/blog/2022/03/01/apisix-integration-public-api-plugin/
