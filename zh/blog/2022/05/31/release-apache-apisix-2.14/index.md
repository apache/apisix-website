# Apache APISIX 2.14.1 正式发布

> Apache APISIX 2.14.1 正式发布！该版本支持在控制面实现服务发现，还支持 Istio、基于 WebSocket 的 pubsub 代理框架和基于 xRPC 框架管理非 HTTP 七层协议。

Source: https://apisix.apache.org/zh/blog/2022/05/31/release-apache-apisix-2.14/
