...
> 云原生 API 网关 Apache APISIX 近两周新增了 openid-connect 插件中支持 PKCE、Ingress 资源可以直接使用 APISIX 的插件等功能。

Source: https://apisix.apache.org/zh/blog/2022/08/09/weekly-report-0731/
