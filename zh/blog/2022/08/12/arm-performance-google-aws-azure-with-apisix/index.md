# GCP、AWS、Azure 和 Oracle ARM 架构服务器性能测试对比

> 本文使用 API 网关 Apache APISIX 来比较 GCP、AWS 、Azure 和 Oracle ARM 架构服务器在网络 IO 密集型场景下的性能。

Source: https://apisix.apache.org/zh/blog/2022/08/12/arm-performance-google-aws-azure-with-apisix/
