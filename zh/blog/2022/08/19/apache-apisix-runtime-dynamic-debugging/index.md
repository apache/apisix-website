# Apache APISIX 运行时动态调试功能详解

> 本文详细介绍了云原生 API 网关 Apache APISIX 动态调试功能以及该功能的实现原理，你可以通过该功能更便捷地排查 Bug 并解决相关问题。

Source: https://apisix.apache.org/zh/blog/2022/08/19/apache-apisix-runtime-dynamic-debugging/
...
基于一个朴素的认知，计算机是不会骗人的，`conf.response_expr` 对象的 `metatable` 对象丢失一定会存在非常合理的解释。我们查看了相关代码，并基于已知的信息梳理了代码执行路径，做了以下两点推测：
