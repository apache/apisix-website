# Apache APISIX 2.15 正式发布

> API 网关 Apache APISIX 2.15 版本正式发布！此版本新增插件相关的自定义优先级、执行策略、错误响应及支持监控四层流量的指标等功能。

Source: https://apisix.apache.org/zh/blog/2022/07/29/release-apache-apisix-2.15/
