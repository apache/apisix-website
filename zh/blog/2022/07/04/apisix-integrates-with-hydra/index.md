# APISIX 与 Ory Hydra 集成丰富身份认证方式

> 本文介绍了 API 网关 Apache APISIX 通过 OpenID Connect 插件与 Ory Hydra 集成实现集中式身份认证，并且介绍了关于 Ory Hydra 的应用场景及 OpenID 相关知识。

Source: https://apisix.apache.org/zh/blog/2022/07/04/apisix-integrates-with-hydra/
