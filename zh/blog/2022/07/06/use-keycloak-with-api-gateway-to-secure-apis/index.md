...
> 本篇文章将一步一步引导你如何使用 API 网关 Apache APISIX 与 Keycloak 保护你的 API，并且介绍了 OpenID Connect 相关概念以及交互流程和相关术语。

Source: https://apisix.apache.org/zh/blog/2022/07/06/use-keycloak-with-api-gateway-to-secure-apis/
