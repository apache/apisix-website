...
> 本文将为你介绍云原生 API 网关 Apache APISIX 的 prometheus 插件的相关信息，并通过此插件监控 APISIX，也为你演示了如何在 APISIX Dashboard 中配置 Grafana。

Source: https://apisix.apache.org/zh/blog/2022/07/13/monitor-api-gateway-apisix-with-prometheus/
...
<div class="code-title">./prometheus.yml</div>
...
<div class="code-title">/usr/share/grafana/conf/defaults.ini</div>
