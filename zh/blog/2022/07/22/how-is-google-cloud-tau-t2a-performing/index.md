...
> 本文主要使用云原生 API 网关 Apache APISIX 分别在 Google Cloud T2A 和 Google Cloud T2D 进行性能测试，并且进行对比两者的性能。

Source: https://apisix.apache.org/zh/blog/2022/07/22/how-is-google-cloud-tau-t2a-performing/
