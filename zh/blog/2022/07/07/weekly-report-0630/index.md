...
> 云原生 API 网关 Apache APISIX 近两周新增了支持用户自定义插件优先级、检查配置文件中的 plugin_metadata、`kafka` 插件新增相关参数支持等功能。

Source: https://apisix.apache.org/zh/blog/2022/07/07/weekly-report-0630/
