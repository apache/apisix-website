...
> 本文主要介绍了如何通过 DataAnt Agent 将云原生 API Gateway Apache APISIX 的指标数据上传到 DataAnt 监控系统，实现对 Apache APISIX 进行监控。

Source: https://apisix.apache.org/zh/blog/2022/07/05/use-dataant-to-monitor-apisix/
