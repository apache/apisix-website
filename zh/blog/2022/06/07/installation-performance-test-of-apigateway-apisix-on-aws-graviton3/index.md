...
> 本文使用 APISIX 进行了 AWS Graviton3 与 AWS Graviton2 的性能对比，在 API 网关这种网络 IO 密集型的计算场景下，AWS Graviton3 可谓展示了性能怪兽的属性。

Source: https://apisix.apache.org/zh/blog/2022/06/07/installation-performance-test-of-apigateway-apisix-on-aws-graviton3/
