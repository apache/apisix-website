# APISIX 的 AI Gateway 功能一览：LLM 代理、Token 限流、安全防护

> 探索 APISIX AI Gateway 的强大功能，包括 LLM 代理、智能流量调度、Token 限流、安全防护等。通过开源插件实现多 LLM 负载均衡、API 速率控制、内容审核，优化 AI 应用的性能、安全性和成本控制。

Source: https://apisix.apache.org/zh/blog/2025/02/24/apisix-ai-gateway-features/
