...
> 了解 AI 与 MCP 场景下的 API 管理需求，以及 Apache APISIX 如何用于 LLM 流量路由、安全、审计和成本控制。

Source: https://apisix.apache.org/zh/blog/2025/04/01/embrace-intelligent-api-management-with-ai-and-mcp/
