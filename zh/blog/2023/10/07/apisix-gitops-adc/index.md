# APISIX 新特性之 GitOps 声明式配置

> APISIX 引入了新的周边工具：支持 GitOps 声明式，帮助用户在非 Kubernetes 环境中以声明式的方式进行各种集成。

Source: https://apisix.apache.org/zh/blog/2023/10/07/apisix-gitops-adc/
...
<div class="code-title">openAPI.yaml</div>
