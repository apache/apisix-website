# 使用 Apache APISIX 评估 Coraza WAF

> 使用 Apache APISIX 评估 phase 1 Coraza Proxy Wasm 策略，了解当前请求体处理限制，并安全测试 OWASP Core Rule Set。

Source: https://apisix.apache.org/zh/blog/2023/09/08/apisix-integrates-with-coraza/
