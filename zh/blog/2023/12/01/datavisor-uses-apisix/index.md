# API 网关 APISIX 在 DataVisor 的应用与实践

> DataVisor 产品专注于风险管理，其研发过程中不仅将 APISIX 充分运用于生产环境，而且也基于 APISIX 进行了多维度的二次开发，最终实现了卓越的生产效果。

Source: https://apisix.apache.org/zh/blog/2023/12/01/datavisor-uses-apisix/
