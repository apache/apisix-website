# Apache APISIX 3.18.0 正式发布

> Apache APISIX 3.18.0 版本于 2026 年 8 月 20 日发布。该版本新增 AI 响应缓存、语义模型路由、安全插件、L4 增强与可观测性能力，并包含需要注意的升级变更。

Source: https://apisix.apache.org/zh/blog/2026/08/20/release-apache-apisix-3.18.0/
