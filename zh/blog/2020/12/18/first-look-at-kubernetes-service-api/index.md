...
> 本文介绍了 Kubernetes Service APIs 的基本概念、主要特点、以及如何管理资源读写权限和主要的扩展点，以及推行会带来的改变。

Source: https://apisix.apache.org/zh/blog/2020/12/18/first-look-at-kubernetes-service-api/
