# 贝壳找房如何基于 APISIX 搭建网关

> 贝壳找房选择使用云原生 API 网关 Apache APISIX 作为 API 网关，每天处理上亿流量，性能优异而且非常稳定，并且相比于 Kong，Apache APISIX 更容易入门。

Source: https://apisix.apache.org/zh/blog/2020/12/11/beike-how-to-build-gateway-based-on-apache-apisix/
