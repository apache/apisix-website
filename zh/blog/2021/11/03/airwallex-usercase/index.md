# Apache APISIX 如何通过网关层为 Airwallex 数据主权保驾护航

> 本文介绍了 Airwallex 空中云汇是如何使用云原生 API 网关 Apache APISIX 进行网关层部署来加固数据主权方面的建设以及登录与密码重置、复杂场景下的业务操作等场景。

Source: https://apisix.apache.org/zh/blog/2021/11/03/airwallex-usercase/
