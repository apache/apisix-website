...
> 本文介绍了云原生 API 网关 Apache APISIX 为什么选择 Proxy Wasm 来实现功能以及如何在 Apache APISIX 中使用 Wasm 并且通过实际示例演示如何测试插件。

Source: https://apisix.apache.org/zh/blog/2021/11/19/apisix-supports-wasm/
