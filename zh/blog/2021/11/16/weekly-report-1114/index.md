...
> 云原生 API 网关 Apache APISIX 近两周新增支持在 Arch Linux 上安装 APISIX，limit-conn 和 limit-count 插件支持变量作为限流 key 以及 datadog 插件等功能。

Source: https://apisix.apache.org/zh/blog/2021/11/16/weekly-report-1114/
