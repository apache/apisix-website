...
> 本文介绍了云原生 API 网关 Apache APISIX 如何使用 datadog 插件与 Datadog 监控平台的进行集成，并且也介绍了 datadog 插件的实现原理、功能以及具体参数。

Source: https://apisix.apache.org/zh/blog/2021/11/12/apisix-datadog/
