...
> 本文为大家介绍了 Dapr 和 Apache APISIX Ingress Controller 的相关概念，并展示了集成 Dapr 创建一个 Apache APISIX 控制器的具体步骤及测试示例项目。

Source: https://apisix.apache.org/zh/blog/2021/11/17/dapr-with-apisix/
