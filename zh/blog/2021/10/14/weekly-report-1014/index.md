...
> 本周云原生 API 网关 Apache APISIX 社区新增了 ldap-auth 插件，并支持测试配置文件以及支持配置 Service 中 host 字段提供路由默认值等功能。

Source: https://apisix.apache.org/zh/blog/2021/10/14/weekly-report-1014/
