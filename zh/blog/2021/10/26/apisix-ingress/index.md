# APISIX Ingress 项目从 0 到 1 的发展历程

> 本文详细描述了 Apache APISIX Ingress Controller 的成长历程，以及 APISIX Ingress 加入社区后的功能提升与社区帮助等多方面细节收获。

Source: https://apisix.apache.org/zh/blog/2021/10/26/apisix-ingress/
