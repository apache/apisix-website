# 如何在 APISIX Ingress Controller 中使用 Cert Manager 管理证书

> Apache APISIX Ingress Controller 已经实现了证书管理、负载均衡、金丝雀发布等功能，本文介绍了如何通过 Cert Manager 在 APISIX Ingress Controller 里进行证书管理。

Source: https://apisix.apache.org/zh/blog/2021/10/22/cert-manager-in-ingress/
