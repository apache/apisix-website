# Apache APISIX 2.9 正式发布

> 云原生 API 网关 Apache APISIX 2.9 版本正式发布！该版本新增了 authz-casbin 插件、路由级别上 real-ip 的动态配置以及完善外部插件机制。

Source: https://apisix.apache.org/zh/blog/2021/08/27/release-apache-apisix-2.9/
