...
> 本文介绍了为什么贡献者数量变化是衡量开源项目的金指标，并且使用贡献者趋势图分析了云原生 API 网关 Apache APISIX 的贡献者趋势以及与其他开源项目的对比。

Source: https://apisix.apache.org/zh/blog/2021/08/14/contributors-the-golden-metric-of-opensource-projects/
