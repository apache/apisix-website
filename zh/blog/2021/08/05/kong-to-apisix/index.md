...
> 你可以使用 Kong-To-APISIX 迁移工具，一键将 Kong 的配置迁移到云原生 API 网关 Apache APISIX 中，实现服务的无缝切换。本文介绍了详细的使用方法以及测试示例。

Source: https://apisix.apache.org/zh/blog/2021/08/05/kong-to-apisix/
