...
> 本文将从 Nginx 可观测性、Apache APISIX 与 Nginx 的关系、Apache APISIX 可观测性，以及结合 Apache SkyWalking 进一步提升可观测性等方面分享关于可观测性的方案与实践。

Source: https://apisix.apache.org/zh/blog/2021/08/06/using-apache-apisix-to-improve-the-observability-of-nginx/
