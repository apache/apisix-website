# 在 APISIX 中使用 Casbin 授权

> 当你在使用 API 网关 Apache APISIX 时，可能需要添加复杂的授权逻辑。你可以使用 APISIX 的内置 Casbin 插件（authz-casbin）来实现基于角色的访问控制（RBAC）模型。

Source: https://apisix.apache.org/zh/blog/2021/08/18/auth-with-casbin-in-apache-apisix/
