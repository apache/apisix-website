...
> 本周 Apache APISIX 新增了 uri-blocker 支持匹配请求 URI 时忽略大小写，kafka-logger 支持配置 kafka 生产者的 acks 和 cluster name 参数等功能。

Source: https://apisix.apache.org/zh/blog/2021/08/30/weekly-report/
