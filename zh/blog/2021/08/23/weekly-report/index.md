...
> 本周 Apache APISIX 新增了 gzip 插件支持特殊的 * 来匹配任何类型，ext-plugin 插件支持 ExtraInfo，uri-blocker 插件支持自定义失败响应等功能。

Source: https://apisix.apache.org/zh/blog/2021/08/23/weekly-report/
