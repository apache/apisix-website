...
> 本文详细讲解如何用 Go 来开发云原生 API 网关 Apache APISIX 的插件。通过拥抱 Go 的生态圈，为 APISIX 开创一片新天地，希望 Go 能让 APISIX 如虎添翼！

Source: https://apisix.apache.org/zh/blog/2021/08/19/go-makes-apache-apisix-better/
