# Apache APISIX 社区周报（8.9-8.15）

> 本周 Apache APISIX 新增了流量控制类插件增加降级处理、log-rotate 插件支持压缩已切割的日志文件、real-ip 插件及 consumer-restriction 支持根据 Route 对象做限制。

Source: https://apisix.apache.org/zh/blog/2021/08/19/weekly-report/
