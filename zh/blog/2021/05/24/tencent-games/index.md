...
> 通过阅读本文，你不仅可以了解 API 网关是什么、网关模式对传统服务架构的改进，还可以了解腾讯 OTeam 诞生的原因以及 Apache APISIX 是如何在腾讯内部落地的。

Source: https://apisix.apache.org/zh/blog/2021/05/24/tencent-games/
