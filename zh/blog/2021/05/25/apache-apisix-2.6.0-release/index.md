...
> 云原生 API 网关 Apache APISIX 2.6.0-Release 正式发布！支持使用其他语言编写自定义插件、Nacos 服务发现、支持配置 IPv6 DNS 解析 ，欢迎大家下载使用。

Source: https://apisix.apache.org/zh/blog/2021/05/25/apache-apisix-2.6.0-release/
