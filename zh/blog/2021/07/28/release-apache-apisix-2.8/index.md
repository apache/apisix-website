# Apache APISIX 2.8 正式发布

> Apache APISIX 2.8 版本发布了以下功能：独立的 Keepalive 连接池、stream 代理功能增强、gzip 插件、支持通过插件的方式执行特定逻辑、支持自定义 balancer。

Source: https://apisix.apache.org/zh/blog/2021/07/28/release-apache-apisix-2.8/
