...
> 本文分析了 NGINX 新浪微博使用 NGINX 时的痛点和为什么选择 Apache APISIX 作为公司的 API 网关，以及对 Apache APISIX 进行了哪些二次开发。

Source: https://apisix.apache.org/zh/blog/2021/07/06/the-road-to-customization-of-sina-weibo-api-gateway-based-on-apache-apisix/
