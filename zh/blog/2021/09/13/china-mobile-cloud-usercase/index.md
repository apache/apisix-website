...
> 通过阅读本文，您可以了解到中国移动云是如何基于云原生 API 网关 Apache APISIX 进行对象存储产品的开发和功能改进与更新，打造出更完善的移动云对象存储。

Source: https://apisix.apache.org/zh/blog/2021/09/13/china-mobile-cloud-usercase/
