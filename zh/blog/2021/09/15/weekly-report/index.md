# 社区周报｜社区持续活跃，功能亮点更新进行中

> Apache APISIX 社区最近两周新增了 proxy-mirror 支持按比例镜像请求、Admin API 支持返回 stream 类型的插件信息、dashboard 支持 Service Discovery 配置等功能。

Source: https://apisix.apache.org/zh/blog/2021/09/15/weekly-report/
