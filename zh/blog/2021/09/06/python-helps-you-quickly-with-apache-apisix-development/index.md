...
> 云原生 API 网关 Apache APISIX 目前已经支持了 Java、Go 以及 Python 等语言编写插件。本文将为你介绍如何使用 Python 在 APISIX 上开发自定义插件。

Source: https://apisix.apache.org/zh/blog/2021/09/06/python-helps-you-quickly-with-apache-apisix-development/
