...
> 云原生 API 网关 Apache APISIX 最近两周新增了 stream_route 支持在 IP 匹配中使用 CIDR，debug 模式支持动态请求过滤，hmac-auth 支持校验请求体等新功能。

Source: https://apisix.apache.org/zh/blog/2021/09/30/weekly-report/
