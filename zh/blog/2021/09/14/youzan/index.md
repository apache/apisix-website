# APISIX 在有赞云原生 PaaS 平台的应用实践

> 本文介绍了有赞云原生 PaaS 平台如何使用云原生 API 网关 Apache APISIX 作为产品流量网关的具体示例，以及为什么选择 Apache APISIX作为业务网关及其带来的好处。

Source: https://apisix.apache.org/zh/blog/2021/09/14/youzan/
