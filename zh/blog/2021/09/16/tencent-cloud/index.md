# APISIX 在腾讯云智能钛平台的落地实践

> 本文主要介绍了腾讯云智能钛平台使用云原生 API 网关 Apache APISIX 的企业案例，以及使用 Apache APISIX 作为产品流量网关的具体示例。

Source: https://apisix.apache.org/zh/blog/2021/09/16/tencent-cloud/
