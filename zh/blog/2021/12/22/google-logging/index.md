# API 网关现已支持对接 Google Cloud Logging

> 本文介绍了如何通过 API 网关 Apache APISIX 的 google-cloud-logging 插件与 Google Cloud Logging 服务对接，并将 Apache APISIX 的日志上传到 Google 云中。

Source: https://apisix.apache.org/zh/blog/2021/12/22/google-logging/
