...
> 通过 API 网关 Apache APISIX 的 openid-connect 插件可以与 Keycloak 进行身份认证。通过该插件，APISIX 仅需通过配置即可实现对使用者和应用服务进行认证与鉴权。

Source: https://apisix.apache.org/zh/blog/2021/12/10/integrate-keycloak-auth-in-apisix/
