...
> 本文主要介绍云原生 API 网关 Apache APISIX 集成 SkyWalking 的日志插件，为之后用户在 Apache APISIX 中进行日志处理提供更方便的操作与环境。

Source: https://apisix.apache.org/zh/blog/2021/12/07/apisix-integrate-skywalking-plugin/
