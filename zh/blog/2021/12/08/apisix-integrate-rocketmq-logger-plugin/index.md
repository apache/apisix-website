# API 网关 APISIX 集成 RocketMQ 扩展日志监控功能

> 本文介绍了 API 网关 Apache APISIX 新增的 rocketmq-logger 日志插件，通过该插件可以帮助你在使用 Apache APISIX 时更方便的与 RocketMQ 集群连接。

Source: https://apisix.apache.org/zh/blog/2021/12/08/apisix-integrate-rocketmq-logger-plugin/
