# API 网关 APISIX 现已支持 Azure Functions

> 本文介绍了 API 网关 Apache APISIX 新增的插件 `azure-functions`，并展示了如何将 Azure Functions（一种广泛使用的 serverless 解决方案）集成到 APISIX 中。

Source: https://apisix.apache.org/zh/blog/2021/12/01/apisix-supports-azure-functions/
