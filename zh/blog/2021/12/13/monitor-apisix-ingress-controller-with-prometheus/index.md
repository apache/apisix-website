...
> 本文介绍了如何使用 Prometheus 监控 Apache APISIX Ingress Controller 的相关步骤和部分指标的展示效果，并为大家介绍相关监控指标的定义。

Source: https://apisix.apache.org/zh/blog/2021/12/13/monitor-apisix-ingress-controller-with-prometheus/
