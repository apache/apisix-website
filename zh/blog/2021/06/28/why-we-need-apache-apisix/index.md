...
> 本文介绍了云原生 API 网关 Apache APISIX 架构演进历史，对比 Nginx 和 Kong 这两个框架 Apache APISIX 的优势是什么，并且介绍 APISIX 未来的趋势。

Source: https://apisix.apache.org/zh/blog/2021/06/28/why-we-need-apache-apisix/
