...
> 本文介绍了如何使用 Chaos Mesh 测试 API 网关 Apache APISIX 的相关流程及场景，用来提升 APISIX 的稳定性。并且介绍了未来 APISIX 的测试计划。

Source: https://apisix.apache.org/zh/blog/2021/06/16/chaos-mesh-helps-apache-apisix-improve-stability/
