...
> 云原生 API 网关 Apache APISIX 的性能在开启多个 worker 进行时，性能比 Envoy强大。APISIX 在性能和延迟上的表现使它在处理南北向流量上具有海量的吞吐能力。

Source: https://apisix.apache.org/zh/blog/2021/06/10/apache-apisix-and-envoy-performance-comparison/
