...
Source: https://apisix.apache.org/zh/docs/docker/manual/
...
You need etcd docker to work with Apache APISIX. You can refer to [the docker-compose example](/docs/docker/example/).
