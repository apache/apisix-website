...
> Configure the APISIX Ingress Controller using the config.yaml file, including configurations such as log settings, leader election, metrics, and sync behavior.

Source: https://apisix.apache.org/zh/docs/ingress-controller/reference/apisix-ingress-controller/configuration-file/
