...
- Set [`listener_port_match_mode`](/docs/ingress-controller/reference/configuration-file/) to `"off"` in the controller configuration to disable `server_port` route-var injection.
