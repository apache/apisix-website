...
> Explore detailed reference documentation for the custom resource definitions (CRDs) supported by the APISIX Ingress Controller.

Source: https://apisix.apache.org/zh/docs/ingress-controller/reference/apisix-ingress-controller/api-reference/
