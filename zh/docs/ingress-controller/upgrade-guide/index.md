...
Source: https://apisix.apache.org/zh/docs/ingress-controller/upgrade-guide/
...
![upgrade to 2.0.0 architecture](https://raw.githubusercontent.com/apache/apisix-ingress-controller/master/docs/assets/images/upgrade-to-architecture.png)
