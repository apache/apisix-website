...
> Overview of the APISIX Ingress Controller, its features, APISIX compatibility, and how to contribute to the project.

Source: https://apisix.apache.org/zh/docs/ingress-controller/overview/
...
See the [Getting Started tutorials](/docs/ingress-controller/getting-started/get-apisix-ingress-controller/) to set up and start using the APISIX Ingress Controller.
...
You can contribute to the development of APISIX ingress controller. See [Development guide](/docs/ingress-controller/developer-guide/) for instructions on setting up the project locally.
