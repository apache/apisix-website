...
Source: https://apisix.apache.org/zh/docs/ingress-controller/developer-guide/
...
To install the [CRD](/docs/ingress-controller/concepts/resources/#apisix-ingress-controller-crds-api) and [Gateway API](https://gateway-api.sigs.k8s.io/), run the following commands:
