...
> Learn how to quickly install and set up Apache APISIX Ingres Controller.

Source: https://apisix.apache.org/zh/docs/ingress-controller/getting-started/get-apisix-ingress-controller/
...
More details on the installation can be found in the [Installation Guide](/docs/ingress-controller/install/).
