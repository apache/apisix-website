...
Source: https://apisix.apache.org/zh/docs/apisix/deployment-modes/
...
More information about using environment variables can be found [here](/docs/apisix/admin-api/#using-environment-variables).
