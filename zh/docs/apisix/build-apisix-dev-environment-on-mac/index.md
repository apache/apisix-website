...
> 本文介绍了如何用 Docker 的方式在 Mac 上快速构建 API 网关 Apache APISIX 的开发环境。

Source: https://apisix.apache.org/zh/docs/apisix/build-apisix-dev-environment-on-mac/
...
你可以在[这里](/zh/docs/apisix/install-dependencies/#安装)看到具体支持的系统。
...
![Docker-Desktop File Sharing 设置](https://raw.githubusercontent.com/apache/apisix/master/docs/assets/images/update-docker-desktop-file-sharing.png)
