...
Source: https://apisix.apache.org/zh/docs/apisix/certificate/
...
APISIX 目前支持在多处设置 CA 证书，比如 [保护 Admin API](/zh/docs/apisix/mtls/#保护-admin-api)，[保护 ETCD](/zh/docs/apisix/mtls/#保护-etcd)，以及 [部署模式](/zh/docs/apisix/deployment-modes/) 等。
