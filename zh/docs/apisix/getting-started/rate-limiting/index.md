...
Source: https://apisix.apache.org/zh/docs/apisix/getting-started/rate-limiting/
...
1. 参考[入门指南](/zh/docs/apisix/getting-started/README/)完成 APISIX 的安装。
2. 完成[配置路由](/zh/docs/apisix/getting-started/configure-routes/#route-是什么)。

## 启用 Rate Limiting

在教程[配置路由](/zh/docs/apisix/getting-started/configure-routes/)中，我们已经创建了路由 `getting-started-ip`，我们通过 `PATCH` 方法为该路由增加 `limit-count` 插件：
