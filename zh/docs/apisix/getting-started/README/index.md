...
Source: https://apisix.apache.org/zh/docs/apisix/getting-started/README/
...
APISIX 提供内置的 Dashboard UI，可访问 `http://127.0.0.1:9180/ui` 使用。更多指南请阅读 [Apache APISIX Dashboard](/zh/docs/apisix/dashboard/)。

## 下一步

如果你已经成功地安装了 APISIX 并且正常运行，那么你可以继续进行下面的教程。

* [配置路由](/zh/docs/apisix/getting-started/configure-routes/)
* [负载均衡](/zh/docs/apisix/getting-started/load-balancing/)
* [限速](/zh/docs/apisix/getting-started/rate-limiting/)
* [密钥验证](/zh/docs/apisix/getting-started/key-authentication/)
