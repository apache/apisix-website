...
Source: https://apisix.apache.org/zh/docs/apisix/tutorials/manage-api-consumers/
...
阅读我们的其他 [教程](/zh/docs/apisix/tutorials/expose-api/)，以了解更多有关 **API 管理（API Management）** 的内容。
