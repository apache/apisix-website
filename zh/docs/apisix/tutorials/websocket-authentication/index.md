...
> This article is a guide on how to configure authentication for WebSocket connections.

Source: https://apisix.apache.org/zh/docs/apisix/tutorials/websocket-authentication/
...
<div class="code-title">Client request</div>
...
<div class="code-title">Server response</div>
