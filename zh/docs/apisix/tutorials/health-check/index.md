...
> 本文介绍了如何使用 API 网关 Apache APISIX 的健康检查功能来检查上游节点的健康状态。

Source: https://apisix.apache.org/zh/docs/apisix/tutorials/health-check/
...
你可以通过[控制接口](/zh/docs/apisix/control-api/) 中的 `GET /v1/healthcheck` 接口获取健康检查信息。如下所示：
