...
> 本文介绍如何使用 openid-connect 插件，通过 authorization code grant、client credentials grant 和 password grant 将 APISIX 与 Keycloak 集成。

Source: https://apisix.apache.org/zh/docs/apisix/tutorials/keycloak-oidc/
