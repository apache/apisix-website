...
> 本文介绍了如何在客户端和 Apache APISIX 之间配置双向认证（mTLS）。

Source: https://apisix.apache.org/zh/docs/apisix/tutorials/client-to-apisix-mtls/
...
想了解更多有关 Apache APISIX 的 mTLS 功能介绍，可以阅读：[TLS 双向认证](/zh/docs/apisix/mtls/)。
