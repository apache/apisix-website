...
> 本文将介绍如何在 Apache APISIX 中基于 Kubernetes 进行服务发现以及相关问题汇总。

Source: https://apisix.apache.org/zh/docs/apisix/discovery/kubernetes/
...
同时遵循 [_APISIX Discovery 规范_](/zh/docs/apisix/discovery/) 提供了节点查询接口。
...
单集群模式 Kubernetes 服务发现遵循 [_APISIX Discovery 规范_](/zh/docs/apisix/discovery/) 提供节点查询接口。
...
多集群模式 Kubernetes 服务发现遵循 [_APISIX Discovery 规范_](/zh/docs/apisix/discovery/) 提供节点查询接口。
