...
> 本文介绍了如何选择 Apache APISIX 的 Router。

Source: https://apisix.apache.org/zh/docs/apisix/terminology/router/
...
- `apisix.router.http`: HTTP 请求路由。
  ...
  - `radixtree_uri`：只使用 `uri` 作为主索引。基于 `radixtree` 引擎，支持全量和深前缀匹配，更多信息请参考[如何使用 router-radixtree](/zh/docs/apisix/router-radixtree/)。
