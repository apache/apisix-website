...
> 本文档将引导你了解如何升级 APISIX 版本。

Source: https://apisix.apache.org/zh/docs/apisix/upgrade-guide-from-2.15.x-to-3.0.0/
...
在升级之前，请查看 [3.0.0-beta](/zh/docs/apisix/CHANGELOG/#300-beta) 和 [3.0.0](/zh/docs/apisix/CHANGELOG/#300) 中的 Change 部分，以了解 3.0.0 版本的不兼容的修改与重大更新。
...
- CentOS 7 和 CentOS 8 的 RPM 包，支持 AMD64 和 ARM64 架构，可参考文章[通过 RPM 仓库安装](/zh/docs/apisix/installation-guide/#通过-rpm-仓库安装)
- Debian 11(bullseye) 的 DEB 包，支持 AMD64 和 ARM64 架构，可参考文章[通过 DEB 仓库安装](/zh/docs/apisix/installation-guide/#通过-deb-仓库安装)

3.0.0 对部署模式进行了重大更新，具体如下：

- 支持数据面与控制面分离的部署模式，具体可参考 [Decoupled](/zh/docs/apisix/deployment-modes/#decoupled)
- 如在使用中仍需沿用原来的部署模式，那么可以使用部署模式中的 `traditional` 模式，并且更新配置文件，具体可参考 [Traditional](/zh/docs/apisix/deployment-modes/#traditional)
- 支持 Standalone 模式，需要更新配置文件，具体可参考 [Standalone](/zh/docs/apisix/deployment-modes/#standalone)
