...
Source: https://apisix.apache.org/zh/docs/apisix/dashboard/
...
![Apache APISIX Dashboard - Need Admin Key](https://raw.githubusercontent.com/apache/apisix/master/docs/assets/images/dashboard-need-admin-key.png)
...
![Apache APISIX Dashboard - Reopen Settings Modal](https://raw.githubusercontent.com/apache/apisix/master/docs/assets/images/dashboard-reopen-settings-modal.png)

接下来，填入上一小节中配置的 Admin API Key，Dashboard 会自动发起请求。如配置错误，Dashboard 仍将在右上角显示 `failed to check token`：

![Apache APISIX Dashboard - Admin Key is wrong](https://raw.githubusercontent.com/apache/apisix/master/docs/assets/images/dashboard-admin-key-is-wrong.png)

如配置正确，Dashboard 将不再显示 `failed to check token`。此时，点击 `X` 或空白处，关闭设置模态框，即可正常使用。

![Apache APISIX Dashboard - Admin Key is correct](https://raw.githubusercontent.com/apache/apisix/master/docs/assets/images/dashboard-admin-key-is-correct.png)
