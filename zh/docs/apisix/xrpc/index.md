...
Source: https://apisix.apache.org/zh/docs/apisix/xrpc/
...
To know how to enable Prometheus metrics for TCP and collect them, please refer to [prometheus](/docs/apisix/plugins/prometheus/).
