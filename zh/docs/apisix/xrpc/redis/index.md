...
> This document contains information about the Apache APISIX xRPC implementation for Redis.

Source: https://apisix.apache.org/zh/docs/apisix/xrpc/redis/
...
This feature requires APISIX to be run on [APISIX-Runtime](/docs/apisix/FAQ/#how-do-i-build-the-apisix-runtime-environment).
