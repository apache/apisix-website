...
> 本文介绍了 Apache APISIX 支持的变量。

Source: https://apisix.apache.org/zh/docs/apisix/apisix-variable/
...
当然，除上述变量外，你也可以创建自定义[变量](/zh/docs/apisix/plugin-develop/#register-custom-variable)。
