...
> 本文介绍了如何在本地使用源码安装 API 网关 Apache APISIX 来构建开发环境。

Source: https://apisix.apache.org/zh/docs/apisix/building-apisix/

如果你希望为 APISIX 做出贡献或配置开发环境，你可以参考本教程。

如果你想通过其他方式安装 APISIX，你可以参考[安装指南](/zh/docs/apisix/installation-guide/)。
...
如果你想要了解更多信息，请参考 [testing framework](/zh/docs/apisix/internal/testing-framework/)。
