...
> This document contains information about the Apache APISIX kafka pubsub scenario.

Source: https://apisix.apache.org/zh/docs/apisix/pubsub/kafka/
...
Simply turn on the `kafka-proxy` plugin on the created route and enable the Kafka TLS handshake and SASL authentication through the configuration, which can be found in the [plugin documentation](/docs/apisix/plugins/kafka-proxy/).
