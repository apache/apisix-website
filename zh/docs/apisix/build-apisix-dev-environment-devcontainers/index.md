# Build development environment with Dev Containers

> This paper introduces how to quickly start the APISIX API Gateway development environment using Dev Containers.

Source: https://apisix.apache.org/zh/docs/apisix/build-apisix-dev-environment-devcontainers/
...
The tutorial can be used as an alternative to a [bare-metal environment](/docs/apisix/building-apisix/) or a [macOS container development environment](/docs/apisix/build-apisix-dev-environment-on-mac/).
...
![VSCode Command open in container](https://raw.githubusercontent.com/apache/apisix/master/docs/assets/images/build-devcontainers-vscode-command.png)
...
![VSCode dev containers building progress bar](https://raw.githubusercontent.com/apache/apisix/master/docs/assets/images/build-devcontainers-vscode-progressbar.png)
