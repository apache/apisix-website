...
Source: https://apisix.apache.org/zh/docs/apisix/plugins/dubbo-proxy/
...
如果你正在使用 `OpenResty`, 你需要编译它来支持 `dubbo`, 参考 [APISIX-Runtime](/zh/docs/apisix/FAQ/#如何构建-apisix-runtime-环境)。
