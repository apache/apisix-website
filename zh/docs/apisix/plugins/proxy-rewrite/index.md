...
Source: https://apisix.apache.org/zh/docs/apisix/plugins/proxy-rewrite/
...
以下示例演示如何使用 `uri_param_*` 变量提取 URL 路径的一部分，并将其值转发到上游服务的新标头中。此示例假设 APISIX 运行在 `radixtree_uri_with_parameter` [路由模式](/zh/docs/apisix/router-radixtree/)下。
