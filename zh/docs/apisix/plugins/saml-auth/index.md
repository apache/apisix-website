...
> saml-auth 插件为 API 路由提供 SAML 2.0 身份验证，可与 Keycloak、Okta、Azure Active Directory 等外部身份提供商集成。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/saml-auth/
