...
> ip-restriction 插件支持通过配置 IP 地址白名单或黑名单来限制 IP 地址对上游资源的访问。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/ip-restriction/
...
<div class="code-title">ip-restriction-ic.yaml</div>
