...
> 本文介绍了关于 Apache APISIX `gzip` 插件的基本信息及使用方法。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/gzip/
...
该插件要求 Apache APISIX 运行在 [APISIX-Runtime](/zh/docs/apisix/FAQ/#如何构建-apisix-runtime-环境) 上。
