...
> request-id 插件为通过 APISIX 代理的每个请求添加一个唯一的 ID，可用于跟踪 API 请求。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/request-id/
...
<div class="code-title">request-id-ic.yaml</div>
...
<div class="code-title">global-request-id.yaml</div>
