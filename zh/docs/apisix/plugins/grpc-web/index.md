...
> grpc-web 插件使网关能够处理来自浏览器和 JavaScript 客户端的 gRPC-Web 请求，将其转换为标准 gRPC 调用并转发给上游 gRPC 服务。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/grpc-web/
...
<div class="code-title">client.js</div>
