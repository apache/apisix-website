...
> 本文介绍了关于 Apache APISIX `server-info` 插件的基本信息及使用方法。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/server-info/
...
该插件在 [Control API](/zh/docs/apisix/control-api/) 下暴露了一个 API 接口 `/v1/server_info`。
