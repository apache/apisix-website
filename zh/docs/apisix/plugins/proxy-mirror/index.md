...
> proxy-mirror 插件将入口流量复制到 APISIX 并将其转发到指定的上游，而不会中断常规服务。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/proxy-mirror/
...
<div class="code-title">proxy-mirror-ic.yaml</div>
