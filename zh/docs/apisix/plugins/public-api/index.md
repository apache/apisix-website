...
Source: https://apisix.apache.org/zh/docs/apisix/plugins/public-api/
...
以下示例展示了如何使用 `public-api` 插件来暴露 [batch-requests](/zh/docs/apisix/plugins/batch-requests/) 插件的端点，该插件用于将多个请求组合成一个请求，然后将它们发送到网关。
