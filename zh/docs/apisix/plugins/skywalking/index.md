...
> skywalking 插件支持与 Apache SkyWalking 集成以进行请求跟踪。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/skywalking/
...
| ------------ | ------ | ------ | ------ | ------------ | ----------------------------------------------------- |
| sample_ratio | number | 否     | 1      | [0.00001, 1] | 请求采样频率。将采样率设置为 `1` 表示对所有请求进行采样。 |
