...
> ai-request-rewrite 插件在将客户端请求发送到上游服务之前，将其转发到 LLM 服务进行处理，实现 AI 驱动的脱敏、内容增强和格式转换。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/ai-request-rewrite/
...
<div class="code-title">ai-request-rewrite-gw.yaml</div>
...
<div class="code-title">ai-request-rewrite-ic.yaml</div>
