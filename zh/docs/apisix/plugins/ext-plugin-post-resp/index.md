...
> 本文介绍了关于 Apache APISIX `ext-plugin-post-resp` 插件的基本信息及使用方法。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/ext-plugin-post-resp/
...
- [proxy-control](/zh/docs/apisix/plugins/proxy-control/) 插件不可用
- [proxy-mirror](/zh/docs/apisix/plugins/proxy-mirror/) 插件不可用
- [proxy-cache](/zh/docs/apisix/plugins/proxy-cache/) 插件不可用
- [APISIX 与上游间的双向认证](/zh/docs/apisix/mtls/#apisix-与上游间的双向认证) 功能尚不可用

如果你想了解更多关于 External Plugin 的信息，请参考 [External Plugin](/zh/docs/apisix/external-plugin/) 。
