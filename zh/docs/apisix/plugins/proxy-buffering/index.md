...
> 本文介绍了 Apache APISIX proxy-buffering 插件的相关操作，你可以使用此插件按路由禁用 nginx 代理缓冲，这对于流式响应（如 Server-Sent Events）至关重要。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/proxy-buffering/
