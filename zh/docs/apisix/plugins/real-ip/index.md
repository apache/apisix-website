...
> real-ip 插件允许 Apache APISIX 通过 HTTP 请求头或 HTTP 查询字符串中传递的 IP 地址设置客户端的真实 IP。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/real-ip/
...
<div class="code-title">real-ip-ic.yaml</div>
