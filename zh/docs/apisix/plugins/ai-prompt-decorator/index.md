...
> 本文档包含有关 Apache APISIX ai-prompt-decorator 插件的信息。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/ai-prompt-decorator/
...
以下示例演示了如何配置 `ai-prompt-decorator` 插件，在用户输入消息前添加一条系统消息，并在其后追加一条用户消息。该插件与 [ai-proxy](/zh/docs/apisix/plugins/ai-proxy/) 插件配合使用，将请求转发到 OpenAI。
