...
> aws-lambda 插件支持 APISIX 与 AWS Lambda 和 Amazon API Gateway 集成，支持通过 IAM 访问密钥和 API 密钥进行身份验证。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/aws-lambda/
