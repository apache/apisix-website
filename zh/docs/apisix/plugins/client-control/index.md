...
> 本文介绍了 Apache APISIX proxy-control 插件的相关操作，你可以使用此插件动态地控制 NGINX 处理客户端的请求的行为。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/client-control/
...
此插件需要 APISIX 在 [APISIX-Runtime](/zh/docs/apisix/FAQ/#如何构建-apisix-Runtime-环境) 环境上运行。更多信息请参考 [apisix-build-tools](https://github.com/api7/apisix-build-tools)。
