...
> 本文介绍了关于 Apache APISIX `batch-request` 插件的基本信息及使用方法。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/batch-requests/
...
你需要通过 [public-api](/zh/docs/apisix/plugins/public-api/) 插件来暴露它。
...
你可以通过 [public-api](/zh/docs/apisix/plugins/public-api/) 插件设置自定义 URI。
...
首先，你需要为 `batch-requests` 插件的 API 创建一个路由，它将使用 [public-api](/zh/docs/apisix/plugins/public-api/) 插件。
