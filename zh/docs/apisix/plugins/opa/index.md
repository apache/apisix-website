...
> opa 插件与 Open Policy Agent 集成，支持在 API 操作中统一定义和执行授权策略。

Source: https://apisix.apache.org/zh/docs/apisix/plugins/opa/
...
<div class="code-title">opa-server.yaml</div>
...
<div class="code-title">opa-ic.yaml</div>
...
<div class="code-title">opa-consumers-ic.yaml</div>
...
<div class="code-title">opa-route-ic.yaml</div>
