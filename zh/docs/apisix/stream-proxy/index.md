...
Source: https://apisix.apache.org/zh/docs/apisix/stream-proxy/
...
完整的匹配选项列表参见 [Admin API 的 Stream Route](/zh/docs/apisix/admin-api/#stream-route)。
...
具体步骤参考 [Admin API 的 SSL](/zh/docs/apisix/admin-api/#ssl)。
mTLS 也是支持的，参考 [保护路由](/zh/docs/apisix/mtls/#保护路由)。
