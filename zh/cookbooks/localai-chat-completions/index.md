# 通过 APISIX 代理 LocalAI Chat Completions

> 在私有 LocalAI Chat Completions 接口前部署 APISIX 3.18，并分开管理客户端与上游凭据。

Source: https://apisix.apache.org/zh/cookbooks/localai-chat-completions/
