# 使用 Redis 在多个 APISIX 节点间共享 LLM token 配额

> 验证两个 APISIX 3.18 节点能否通过 Redis 共享 LLM Token 用量，并正确执行跨节点限流与故障降级。

Source: https://apisix.apache.org/zh/cookbooks/redis-shared-token-quota/
