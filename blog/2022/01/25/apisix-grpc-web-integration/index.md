# Integrate Apache APISIX with gRPC-Web

> Configure APISIX to proxy gRPC-Web requests, enabling browser-based gRPC clients to communicate with backend gRPC services.

Source: https://apisix.apache.org/blog/2022/01/25/apisix-grpc-web-integration/
