...
Source: https://apisix.apache.org/blog/2022/09/09/kubernetes-ingress-with-apisix/
...
<div class="code-title">apisix-ingress-manifest.yaml</div>
...
<div class="code-title">kubernetes-ingress-manifest.yaml</div>
