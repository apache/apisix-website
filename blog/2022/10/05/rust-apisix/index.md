# Write APISIX Plugins in Rust with WebAssembly

> Build APISIX plugins using Rust and WebAssembly. Walkthrough of rewriting the response-rewrite plugin in Rust with Wasm support.

Source: https://apisix.apache.org/blog/2022/10/05/rust-apisix/
