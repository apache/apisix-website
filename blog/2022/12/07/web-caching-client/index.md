# Web Caching: Client-Side HTTP Cache Guide

> Master client-side HTTP caching: Cache-Control, ETag, Last-Modified, and freshness strategies. A complete guide to browser caching.

Source: https://apisix.apache.org/blog/2022/12/07/web-caching-client/
