# APISIX integrates with Ory Hydra

> Set up centralized OAuth 2.0 authentication in APISIX using the OpenID Connect plugin with Ory Hydra as the identity provider.

Source: https://apisix.apache.org/blog/2022/07/04/apisix-integrates-with-hydra/
