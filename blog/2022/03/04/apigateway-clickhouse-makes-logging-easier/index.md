...
> Use the APISIX clickhouse-logger plugin to send API gateway logs directly to ClickHouse for efficient log storage and analysis.

Source: https://apisix.apache.org/blog/2022/03/04/apigateway-clickhouse-makes-logging-easier/
