...
> This article describes the features of the cloud-native API gateway Apache APISIX and GraphQL, and how to use Apache APISIX to proxy GraphQL requests.

Source: https://apisix.apache.org/blog/2022/03/02/apisix-integration-graphql/
