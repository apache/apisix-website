# Apache APISIX integrates with Open Policy Agent

> This article takes HTTP API as an example to introduce the `opa` plugin, and explains in detail how to integrate the API gateway Apache APISIX with OPA.

Source: https://apisix.apache.org/blog/2021/12/24/open-policy-agent/
