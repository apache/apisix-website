# Expose Istio Services with APISIX Ingress

> Expose Kubernetes services from an Istio service mesh using APISIX Ingress Controller. Step-by-step integration guide.

Source: https://apisix.apache.org/blog/2021/12/17/exposure-istio-with-apisix-ingress/
