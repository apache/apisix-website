...
> The cloud native API gateway Apache APISIX has added functions related to stream_route, debug mode, and hmac-auth plugin in the past two weeks.

Source: https://apisix.apache.org/blog/2021/09/30/weekly-report/
