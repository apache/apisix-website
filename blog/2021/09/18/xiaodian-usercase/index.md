...
> This article introduces the background and practice of using the cloud native API gateway Apache APISIX to build the cloud native project in DIAN.

Source: https://apisix.apache.org/blog/2021/09/18/xiaodian-usercase/
