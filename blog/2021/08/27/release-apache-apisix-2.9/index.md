...
> The Apache APISIX 2.9 version of the cloud native API gateway adds the authz-casbin plugin and the dynamic configuration of real-ip at the routing level.

Source: https://apisix.apache.org/blog/2021/08/27/release-apache-apisix-2.9/
