...
> You can use the Kong-To-APISIX migration tool to migrate Kong's configuration to the cloud-native API gateway Apache APISIX with one click.

Source: https://apisix.apache.org/blog/2021/08/05/kong-to-apisix/
