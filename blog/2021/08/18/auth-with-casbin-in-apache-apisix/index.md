# RBAC with Casbin in APISIX

> Implement role-based access control in APISIX using the authz-casbin plugin. Step-by-step RBAC configuration guide.

Source: https://apisix.apache.org/blog/2021/08/18/auth-with-casbin-in-apache-apisix/
