...
> Write APISIX plugins in Java and integrate with Spring Cloud. Includes setup steps and plugin runner architecture.

Source: https://apisix.apache.org/blog/2021/06/21/use-java-to-write-apache-apisix-plugins/
