...
> Learn how Apache APISIX AI Gateway handles LLM traffic with model proxying, configured routing, caching, token limits, prompt controls, RAG, and observability.

Source: https://apisix.apache.org/blog/2025/02/24/apisix-ai-gateway-features/
