# Evaluate Coraza WAF with Apache APISIX

> Evaluate a phase-one Coraza Proxy Wasm policy with Apache APISIX, understand current request-body limitations, and test the OWASP Core Rule Set safely.
