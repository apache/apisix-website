# Why Microservices Use an API Gateway

> Learn when microservices need an API gateway, which responsibilities belong at the gateway, and when a simpler alternative is enough.

Source: https://apisix.apache.org/blog/2023/05/19/why-do-microservices-need-an-api-gateway/
