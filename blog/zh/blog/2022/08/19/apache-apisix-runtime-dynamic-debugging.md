...
- Apache APISIX
- Debug
description: 本文详细介绍了云原生 API 网关 Apache APISIX 动态调试功能以及该功能的实现原理，你可以通过该功能更便捷的排查 Bug 并解决相关问题。
tags: [Ecosystem]
---

> 本文详细介绍了 Apache APISIX 动态调试功能以及该功能的实现原理，你可以通过该功能更便捷的排查 Bug 并解决相关问题。
