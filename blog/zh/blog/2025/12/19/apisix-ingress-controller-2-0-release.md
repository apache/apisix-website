---
title: "Apache APISIX Ingress Controller 2.1.0 正式发布"
...
keywords:
  ...
  - Gateway API
  - Apache APISIX
description: Apache APISIX Ingress Controller 2.1.0 正式发布，带来全面的 Gateway API 支持、灵活的多数据面部署模式以及无需 etcd 的轻量级运维，以实现更稳健、可扩展的 Kubernetes 流量管理。
tags: [Community]
...
> 有关完整的功能和变更列表，请参阅完整的 [Release Changelog](https://github.com/apache/apisix-ingress-controller/blob/2.1.0/CHANGELOG.md#210)。
