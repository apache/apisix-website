...
- Kong
- Nginx
description: This article describes why Beike chose Apache APISIX as the API gateway in the first place, and some experiences in the process of using it.
tags: [User Case]
---
