...
Source: https://apisix.apache.org/docs/apisix/getting-started/rate-limiting/
...
1. Complete the [Get APISIX](/docs/apisix/getting-started/README/) step to install APISIX first.
2. Complete the [Configure Routes](/docs/apisix/getting-started/configure-routes/#what-is-a-route) step.

## Enable Rate Limiting

The following route `getting-started-ip` is inherited from [Configure Routes](/docs/apisix/getting-started/configure-routes/). You only need to use the `PATCH` method to add the `limit-count` plugin to the route:
