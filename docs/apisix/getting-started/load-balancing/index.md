...
Source: https://apisix.apache.org/docs/apisix/getting-started/load-balancing/
...
2. Understand APISIX [Route and Upstream](/docs/apisix/getting-started/configure-routes/#what-is-a-route).
