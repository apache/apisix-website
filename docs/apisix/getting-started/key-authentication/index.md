...
Source: https://apisix.apache.org/docs/apisix/getting-started/key-authentication/
...
1. Complete [Get APISIX](/docs/apisix/getting-started/README/) to install APISIX.
2. Complete [Configure Routes](/docs/apisix/getting-started/configure-routes/#what-is-a-route).
...
Inheriting the route `getting-started-ip` from [Configure Routes](/docs/apisix/getting-started/configure-routes/), we only need to use the `PATCH` method to add the `key-auth` plugin to the route:
