...
Source: https://apisix.apache.org/docs/apisix/certificate/
...
APISIX currently uses CA certificates in several places, such as [Protect Admin API](/docs/apisix/mtls/#protect-admin-api), [etcd with mTLS](/docs/apisix/mtls/#etcd-with-mtls), and [Deployment Modes](/docs/apisix/deployment-modes/).
