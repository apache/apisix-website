...
Source: https://apisix.apache.org/docs/apisix/stream-proxy/
...
Read [Admin API's Stream Route section](/docs/apisix/admin-api/#stream-route) for the complete options list.
...
See [Admin API's SSL section](/docs/apisix/admin-api/#ssl) for how to do.
mTLS is also supported, see [Protect Route](/docs/apisix/mtls/#protect-route) for how to do.
