...
> This paper introduces how to use Docker to quickly build the development environment of API gateway Apache APISIX on Mac.

Source: https://apisix.apache.org/docs/apisix/build-apisix-dev-environment-on-mac/
...
You can see the specific supported systems [here](/docs/apisix/install-dependencies/#install).
...
![Docker-Desktop File Sharing Setting](https://raw.githubusercontent.com/apache/apisix/master/docs/assets/images/update-docker-desktop-file-sharing.png)
