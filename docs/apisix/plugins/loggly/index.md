...
Source: https://apisix.apache.org/docs/apisix/plugins/loggly/
...
When the maximum batch size is exceeded, the data in the queue is pushed to Loggly enterprise syslog endpoint. See [batch processor](/docs/apisix/batch-processor/) for more details.
