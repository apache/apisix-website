...
Source: https://apisix.apache.org/docs/apisix/plugins/batch-requests/
...
You can specify a custom URI with the [public-api](/docs/apisix/plugins/public-api/) Plugin.
...
First, you need to setup a Route to the batch request API. We will use the [public-api](/docs/apisix/plugins/public-api/) Plugin for this:
