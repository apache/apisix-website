...
Source: https://apisix.apache.org/docs/apisix/plugins/kafka-logger/
...
The following example demonstrates how to customize the log format using [plugin metadata](/docs/apisix/terminology/plugin-metadata/) and [built-in variables](/docs/apisix/apisix-variable/) to log specific headers from request and response.
