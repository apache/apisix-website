...
> The proxy-buffering Plugin disables nginx proxy buffering per route to enable streaming responses such as Server-Sent Events (SSE).

Source: https://apisix.apache.org/docs/apisix/plugins/proxy-buffering/
