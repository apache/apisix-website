...
Source: https://apisix.apache.org/docs/apisix/plugins/ldap-auth/
...
| ------- | ------ | -------- | -------------------------------------------------------------------------------- |
| user_dn | string | True     | User dn of the LDAP client. For example, `cn=user01,ou=users,dc=example,dc=org`. This field supports saving the value in Secret Manager using the [APISIX Secret](/docs/apisix/terminology/secret/) resource. |
