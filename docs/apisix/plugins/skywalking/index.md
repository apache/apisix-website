...
> The skywalking Plugin supports the integrating with Apache SkyWalking for request tracing.

Source: https://apisix.apache.org/docs/apisix/plugins/skywalking/
