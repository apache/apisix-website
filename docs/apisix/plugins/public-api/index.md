...
Source: https://apisix.apache.org/docs/apisix/plugins/public-api/
...
<div class="code-title">public-api-ic.yaml</div>
...
The following example demonstrates how you can use the `public-api` Plugin to expose an endpoint for the [batch-requests](/docs/apisix/plugins/batch-requests/) Plugin, which is used for assembling multiple requests into one single request before sending them to the gateway.
...
<div class="code-title">public-api-httpbin-ic.yaml</div>
...
<div class="code-title">public-api-batch-ic.yaml</div>
