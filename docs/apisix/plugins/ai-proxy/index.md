...
Source: https://apisix.apache.org/docs/apisix/plugins/ai-proxy/
...
The following example demonstrates how you can log request and response information, including LLM model, token, and payload, and push them to a logger. Before proceeding, you should first set up a logger, such as Kafka. See [`kafka-logger`](/docs/apisix/plugins/kafka-logger/) for more information.
