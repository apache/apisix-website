...
This Plugin shares the same schema as the [limit-count](/docs/apisix/plugins/limit-count/) Plugin. Refer to that page for the full attribute reference. Key attributes are listed below.
