...
Source: https://apisix.apache.org/docs/apisix/plugins/gzip/
...
This Plugin requires APISIX to run on [APISIX-Runtime](/docs/apisix/FAQ/#how-do-i-build-the-apisix-runtime-environment).
