...
Source: https://apisix.apache.org/docs/apisix/plugins/dubbo-proxy/
...
If you are using OpenResty, you need to build it with Dubbo support. See [How do I build the APISIX runtime environment](/docs/apisix/FAQ/#how-do-i-build-the-apisix-runtime-environment) for details.
