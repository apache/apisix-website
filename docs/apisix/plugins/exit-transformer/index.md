...
> The exit-transformer Plugin intercepts APISIX-generated error responses and transforms them using user-defined Lua functions before sending to clients.

Source: https://apisix.apache.org/docs/apisix/plugins/exit-transformer/
