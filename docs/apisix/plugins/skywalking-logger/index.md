...
> The skywalking-logger pushes request and response logs as JSON objects to SkyWalking OAP server in batches and supports the customization of log formats.

Source: https://apisix.apache.org/docs/apisix/plugins/skywalking-logger/
