...
Source: https://apisix.apache.org/docs/apisix/plugins/basic-auth/

## Description

The `basic-auth` Plugin adds [basic access authentication](https://en.wikipedia.org/wiki/Basic_access_authentication) for [Consumers](/docs/apisix/terminology/consumer/) to authenticate themselves before being able to access Upstream resources.
...
<div class="code-title">basic-auth-ic.yaml</div>
