...
Source: https://apisix.apache.org/docs/apisix/plugins/ai-rag/
...
The following example demonstrates how you can use the [`ai-proxy`](/docs/apisix/plugins/ai-proxy/) Plugin to proxy requests to Azure OpenAI LLM and use the `ai-rag` Plugin to generate embeddings and perform vector search to enhance LLM responses.
...
Create a Route with the `ai-rag` and [`ai-proxy`](/docs/apisix/plugins/ai-proxy/) Plugins configured as such:
...
<div class="code-title">ai-rag-ic.yaml</div>
