...
> The aws-lambda Plugin integrates APISIX with AWS Lambda and Amazon API Gateway, supporting authentication via IAM access keys and API keys.

Source: https://apisix.apache.org/docs/apisix/plugins/aws-lambda/
...
<div class="code-title">aws-lambda-ic.yaml</div>
