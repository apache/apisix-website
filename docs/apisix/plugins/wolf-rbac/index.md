...
> This document contains information about the Apache APISIX wolf-rbac Plugin.

Source: https://apisix.apache.org/docs/apisix/plugins/wolf-rbac/

## Description

The `wolf-rbac` Plugin provides a [role-based access control](https://en.wikipedia.org/wiki/Role-based_access_control) system with [wolf](https://github.com/iGeeky/wolf) to a Route or a Service. This Plugin can be used with a [Consumer](/docs/apisix/terminology/consumer/).
...
| appid         | string | False    | "unset"                  | App id added in wolf console. This field supports saving the value in Secret Manager using the [APISIX Secret](/docs/apisix/terminology/secret/) resource.            |
...
You may need to use the [public-api](/docs/apisix/plugins/public-api/) Plugin to expose this endpoint.
