...
> The workflow Plugin supports the conditional execution of user-defined actions to client traffic based on a given set of rules. This provides a granular approach to traffic management.

Source: https://apisix.apache.org/docs/apisix/plugins/workflow/
...
<div class="code-title">workflow-ic.yaml</div>
...
While this example will be using [`key-auth`](/docs/apisix/plugins/key-auth/), you can easily replace it with other authentication Plugins.
