...
> The attach-consumer-label Plugin attaches custom Consumer labels to authenticated requests, for Upstream services to implement additional business logic.

Source: https://apisix.apache.org/docs/apisix/plugins/attach-consumer-label/
