...
> This document contains information about the Apache APISIX ai-prompt-guard Plugin.

Source: https://apisix.apache.org/docs/apisix/plugins/ai-prompt-guard/
...
Create a Route that uses [ai-proxy](/docs/apisix/plugins/ai-proxy/) to proxy to OpenAI and `ai-prompt-guard` to inspect input prompts:
...
Create a Route with the `ai-prompt-guard` and [ai-proxy](/docs/apisix/plugins/ai-proxy/) Plugins configured as such:
...
Create a Route that uses [ai-proxy](/docs/apisix/plugins/ai-proxy/) to proxy to OpenAI and `ai-prompt-guard` to inspect input prompts. Set `match_all_roles` and `match_all_conversation_history` to `true` to validate messages from all roles and the entire conversation:
...
Create a Route with the `ai-prompt-guard` and [ai-proxy](/docs/apisix/plugins/ai-proxy/) Plugins configured as such. Set `match_all_roles` and `match_all_conversation_history` to `true` to validate messages from all roles and the entire conversation:
