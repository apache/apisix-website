# HTTP to Dubbo (http-dubbo)

> This document contains information about the Apache APISIX http-dubbo Plugin.

Source: https://apisix.apache.org/docs/apisix/plugins/http-dubbo/
