...
> The cors Plugin allows you to enable Cross-Origin Resource Sharing (CORS).

Source: https://apisix.apache.org/docs/apisix/plugins/cors/
...
<div class="code-title">cors-ic.yaml</div>
