...
If you are looking to quickly get started with APISIX, check out the other [installation methods](/docs/apisix/installation-guide/).
...
See [testing framework](/docs/apisix/internal/testing-framework/) for more details.
