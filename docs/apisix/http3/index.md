...
> Learn how to enable experimental HTTP/3 support in Apache APISIX for downstream client connections over QUIC.

Source: https://apisix.apache.org/docs/apisix/http3/
