...
Source: https://apisix.apache.org/docs/apisix/control-api/
...
[Plugins](/docs/apisix/terminology/plugin/) can be enabled to add its control API.
...
Returns a [health check](/docs/apisix/tutorials/health-check/) of the APISIX instance.
...
Returns all configured [Routes](/docs/apisix/terminology/route/):
