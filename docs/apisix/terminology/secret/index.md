...
Source: https://apisix.apache.org/docs/apisix/terminology/secret/
...
It now supports the use of the [`namespace` field](/docs/apisix/admin-api/#request-body-parameters-11) to set the multi-tenant namespace concepts supported by [HashiCorp Vault Enterprise](https://developer.hashicorp.com/vault/docs/enterprise/namespaces#vault-api-and-namespaces) and HCP Vault.
