...
> This article describes how to choose a router for Apache APISIX.

Source: https://apisix.apache.org/docs/apisix/terminology/router/
...
- `apisix.router.http`: The HTTP request route. It can take the following values:
  ...
  - `radixtree_uri`: Only use the `uri` as the primary index. To learn more about the support for full and deep prefix matching, check [How to use router-radixtree](/docs/apisix/router-radixtree/).
