...
Source: https://apisix.apache.org/docs/apisix/terminology/credential/

## Description

Credential is the object that holds the [Consumer](/docs/apisix/terminology/consumer/) credential configuration.
...
| plugins | False    | The plugin configuration corresponding to Credential. For more information, see [Plugins](/docs/apisix/terminology/plugin/). |

:::note

For more information about the Credential object, you can refer to the [Admin API Credential](/docs/apisix/admin-api/#credential) resource guide.

:::

## Example

[Consumer Example](/docs/apisix/terminology/consumer/#example) describes how to configure the auth plugin for Consumer and how to use it with other plugins.
