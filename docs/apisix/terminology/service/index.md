...
Source: https://apisix.apache.org/docs/apisix/terminology/service/

## Description

A Service is an abstraction of an API (which can also be understood as a set of [Route](/docs/apisix/terminology/route/) abstractions). It usually corresponds to an upstream service abstraction.
...
As shown, different Routes could be bound to the same Service. This reduces redundancy as these bounded Routes will have the same [Upstream](/docs/apisix/terminology/upstream/) and [Plugin](/docs/apisix/terminology/plugin/) configurations.

For more information about Service, please refer to [Admin API Service object](/docs/apisix/admin-api/#service).
