...
> This article describes the role of the Apache APISIX Upstream object and how to use the Upstream.

Source: https://apisix.apache.org/docs/apisix/terminology/upstream/
...
Although Upstream can be directly configured to the [Route](/docs/apisix/terminology/route/) or [Service](/docs/apisix/terminology/service/), using an Upstream object is recommended when there is duplication as shown below.
...
An Upstream configuration can be directly bound to a Route or a Service, but the configuration in Route has a higher priority. This behavior is consistent with priority followed by the [Plugin](/docs/apisix/terminology/plugin/) object.

## Configuration

In addition to the equalization algorithm selections, Upstream also supports passive health check and retry for the upstream. You can learn more about this [Admin API Upstream](/docs/apisix/admin-api/#upstream).
...
You can learn more about health checks [health-check](/docs/apisix/tutorials/health-check/).
