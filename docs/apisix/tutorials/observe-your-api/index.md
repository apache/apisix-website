...
> Apache APISIX Observability Plugins and take a look at how to set up these plugins.
...
And you can see the [full list](/docs/apisix/plugins/http-logger/) on the official website of Apache APISIX. Now for demo purposes, let's choose a simple but mostly used _http-logger_ plugin that is capable of sending API Log data requests to HTTP/HTTPS servers or sends as JSON objects to Monitoring tools. We can assume that a route and an upstream are created.  You can learn how to set up them in the **[Getting started with Apache APISIX](https://youtu.be/dUOjJkb61so)** video tutorial. Also, you can find all command-line examples on the GitHub page [apisix-observability-plugins](https://boburmirzo.github.io/apisix-observability-plugins/)
...
- [Node status Plugin](/docs/apisix/plugins/node-status/)

- [Datadog Plugin](/docs/apisix/plugins/datadog/)
...
- [Skywalking-plugin](/docs/apisix/plugins/skywalking/)

- [Opentelemetry-plugin](/docs/apisix/plugins/opentelemetry/)
