...
Source: https://apisix.apache.org/docs/apisix/tutorials/cache-api-responses/
...
You can refer to [Expose API](/docs/apisix/tutorials/protect-api/) to learn about how to expose your first API.
