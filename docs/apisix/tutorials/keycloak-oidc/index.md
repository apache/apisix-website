# Set Up SSO with Keycloak (OIDC)

> This article describes how to integrate APISIX with Keycloak using the authorization code grant, client credentials grant, and password grant, using the openid-connect Plugin.

Source: https://apisix.apache.org/docs/apisix/tutorials/keycloak-oidc/
