...
> This article introduce how to perform service discovery based on Kubernetes in Apache APISIX and summarize related issues.

Source: https://apisix.apache.org/docs/apisix/discovery/kubernetes/
...
Discovery also provides a node query interface in accordance with the [_APISIX Discovery Specification_](/docs/apisix/discovery/).
...
The Kubernetes service discovery provides a query interface in accordance with the [_APISIX Discovery Specification_](/docs/apisix/discovery/).
...
To query/list the nodes discovered by kubernetes discovery, you can query the /v1/discovery/kubernetes/dump control API endpoint like so:
