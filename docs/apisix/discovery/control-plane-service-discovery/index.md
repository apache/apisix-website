...
> This documentation describes implementing service discovery through Nacos and ZooKeeper on the API Gateway APISIX Control Plane.

Source: https://apisix.apache.org/docs/apisix/discovery/control-plane-service-discovery/
...
![control-plane-service-discovery](https://raw.githubusercontent.com/apache/apisix/master/docs/assets/images/control-plane-service-discovery.png)
